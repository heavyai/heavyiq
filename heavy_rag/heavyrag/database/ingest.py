...
from heavyrag.database.index import get_or_create_heavydb_index
from heavyrag.database.read import HeavyDBReader
from heavyrag.database.utils import delete_table_nodes, get_existing_tables_from_collection
...
def sync_index(reader: HeavyDBReader) -> VectorStoreIndex:
    ...
    index = get_or_create_heavydb_index(reader.database_name)
    ...
    tables_to_delete_from_index = list(set(existing_tables) - set(reader.tables))
