...
from heavyiq.langchain.logging import log_agent_call
...
def one_time(
    ...
    chat_llm = get_chat_llm(
        tags=["cli", "agent", "one_time_sql_agent"], model=model, temperature=temperature, client=None
    )
...
def conversational(
    ...
    chat_llm = get_chat_llm(
        tags=["cli", "agent", "conversational_sql_agent"], model=model, temperature=temperature, client=None
    )
