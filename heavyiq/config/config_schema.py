...
class HeavyIQConfig(OverrideBaseConfig):  # type: ignore
    ...
    custom_llm_api_context_window: int = 16384  # LLMType.DEFAULT
    custom_llm_api_nl_to_sql_base: Optional[str] = None  # LLMType.NL_TO_SQL
    custom_llm_api_nl_to_sql_context_window: int = 16384  # LLMType.NL_TO_SQL
    custom_llm_api_sql_to_answer_base: Optional[str] = None  # LLMType.SQL_TO_ANSWER
    custom_llm_api_sql_to_answer_context_window: int = 16384  # LLMType.SQL_TO_ANSWER
    custom_llm_api_nl_to_tables_base: Optional[str] = None  # LLMType.NL_TO_TABLES
    custom_llm_api_nl_to_tables_context_window: int = 16384  # LLMType.NL_TO_TABLES
    custom_llm_api_instruct_base: Optional[str] = None  # LLMType.INSTRUCT
    custom_llm_api_instruct_context_window: int = 16384  # LLMType.INSTRUCT
