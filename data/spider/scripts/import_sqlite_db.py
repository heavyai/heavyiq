...
def getOptions(argv=None):
    ...
    parser.add_argument(
        ...
        default="/media/psf/Home/projects/heavynl/data/spider/scripts",
    )
...
def main(argv):
    ...
    db_con = heavyai.connect(
        user=options.user, password=options.password, host=options.host, dbname=db_name
    )
