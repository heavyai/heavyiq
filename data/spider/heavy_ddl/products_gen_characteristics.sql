DROP DATABASE IF EXISTS products_gen_characteristics;
CREATE DATABASE products_gen_characteristics;
ALTER SESSION SET CURRENT_DATABASE = 'products_gen_characteristics';
...
characteristic_type_code TEXT NOT NULL,
