DROP DATABASE IF EXISTS cre_Doc_Tracking_DB;
CREATE DATABASE cre_Doc_Tracking_DB;
ALTER SESSION SET CURRENT_DATABASE = 'cre_Doc_Tracking_DB';
...
Calendar_Date TIMESTAMP(0) NOT NULL,
Day_Number INTEGER);
...
Document_ID INTEGER NOT NULL,
Location_Code CHAR(15) NOT NULL,
Date_in_Location_From TIMESTAMP(0) NOT NULL,
Date_in_Locaton_To TIMESTAMP(0));

CREATE TABLE Documents_to_be_Destroyed (
Document_ID INTEGER NOT NULL,
Destruction_Authorised_by_Employee_ID INTEGER,
Destroyed_by_Employee_ID INTEGER,
Planned_Destruction_Date TIMESTAMP(0),
Actual_Destruction_Date TIMESTAMP(0),
Other_Details TEXT);
