DROP DATABASE IF EXISTS customers_campaigns_ecommerce;
CREATE DATABASE customers_campaigns_ecommerce;
ALTER SESSION SET CURRENT_DATABASE = 'customers_campaigns_ecommerce';
...
mailshot_name TEXT,
mailshot_start_date TIMESTAMP(0),
mailshot_end_date TIMESTAMP(0)
);
...
date_address_from TIMESTAMP(0) NOT NULL,
address_type_code TEXT NOT NULL,
date_address_to TIMESTAMP(0));
...
order_placed_datetime TIMESTAMP(0) NOT NULL,
order_delivered_datetime TIMESTAMP(0),
...
mailshot_customer_date TIMESTAMP(0));
CREATE TABLE Order_Items (
item_id INTEGER NOT NULL ,
order_item_status_code TEXT NOT NULL,
order_id INTEGER NOT NULL,
product_id INTEGER NOT NULL,
item_status_code TEXT,
item_delivered_datetime TIMESTAMP(0),
