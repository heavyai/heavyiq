DROP DATABASE IF EXISTS local_govt_and_lot;
CREATE DATABASE local_govt_and_lot;
ALTER SESSION SET CURRENT_DATABASE = 'local_govt_and_lot';
...
property_id INTEGER NOT NULL,
date_moved_in TIMESTAMP(0) NOT NULL,
date_moved_out TIMESTAMP(0) NOT NULL,
other_details TEXT);
...
resident_id INTEGER NOT NULL,
service_id INTEGER NOT NULL,
date_moved_in TIMESTAMP(0),
property_id INTEGER,
date_requested TIMESTAMP(0),
date_provided TIMESTAMP(0),
other_details TEXT);
