DROP DATABASE IF EXISTS medicine_enzyme_interaction;
CREATE DATABASE medicine_enzyme_interaction;
ALTER SESSION SET CURRENT_DATABASE = 'medicine_enzyme_interaction';
