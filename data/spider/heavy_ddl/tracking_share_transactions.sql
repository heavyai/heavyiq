DROP DATABASE IF EXISTS tracking_share_transactions;
CREATE DATABASE tracking_share_transactions;
ALTER SESSION SET CURRENT_DATABASE = 'tracking_share_transactions';
...
date_of_transaction TIMESTAMP(0),
amount_of_transaction DECIMAL(18,4),
share_count TEXT,
other_details TEXT);
