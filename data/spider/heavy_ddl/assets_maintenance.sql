DROP DATABASE IF EXISTS assets_maintenance;
CREATE DATABASE assets_maintenance;
ALTER SESSION SET CURRENT_DATABASE = 'assets_maintenance';
...
asset_make TEXT,
asset_model TEXT,
asset_acquired_date TIMESTAMP(0),
asset_disposed_date TIMESTAMP(0),
...
fault_log_entry_datetime TIMESTAMP(0),
...
visit_start_datetime TIMESTAMP(0),
visit_end_datetime TIMESTAMP(0),
