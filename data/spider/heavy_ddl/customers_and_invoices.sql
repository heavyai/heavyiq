DROP DATABASE IF EXISTS customers_and_invoices;
CREATE DATABASE customers_and_invoices;
ALTER SESSION SET CURRENT_DATABASE = 'customers_and_invoices';
...
date_order_placed TIMESTAMP(0) NOT NULL,
order_details TEXT);
...
account_id INTEGER ,
customer_id INTEGER NOT NULL,
date_account_opened TIMESTAMP(0),
account_name TEXT,
...
derived_product_cost DECIMAL(18,4),
derived_vat_payable DECIMAL(18,4),
derived_total_cost DECIMAL(18,4));
