DROP DATABASE IF EXISTS products_for_hire;
CREATE DATABASE products_for_hire;
ALTER SESSION SET CURRENT_DATABASE = 'products_for_hire';
...
count_hired TEXT,
amount_payable DECIMAL(18,4),
amount_of_discount DECIMAL(18,4),
amount_outstanding DECIMAL(18,4),
amount_of_refund DECIMAL(18,4));
