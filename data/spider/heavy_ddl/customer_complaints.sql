DROP DATABASE IF EXISTS customer_complaints;
CREATE DATABASE customer_complaints;
ALTER SESSION SET CURRENT_DATABASE = 'customer_complaints';
...
date_product_first_available TIMESTAMP(0),
date_product_discontinued TIMESTAMP(0),
product_name TEXT,
...
complaint_outcome_code TEXT NOT NULL,
complaint_status_code TEXT NOT NULL,
complaint_type_code TEXT NOT NULL,
date_complaint_raised TIMESTAMP(0),
date_complaint_closed TIMESTAMP(0),
