DROP DATABASE IF EXISTS customers_and_products_contacts;
CREATE DATABASE customers_and_products_contacts;
ALTER SESSION SET CURRENT_DATABASE = 'customers_and_products_contacts';
