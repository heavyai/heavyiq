DROP DATABASE IF EXISTS cre_Drama_Workshop_Groups;
CREATE DATABASE cre_Drama_Workshop_Groups;
ALTER SESSION SET CURRENT_DATABASE = 'cre_Drama_Workshop_Groups';
...
Marketing_Region_Name TEXT NOT NULL,
Marketing_Region_Descriptrion TEXT NOT NULL,
Other_Details TEXT);
...
Workshop_Group_ID TEXT NOT NULL,
Status_Code CHAR(15) NOT NULL,
Store_ID INTEGER NOT NULL,
Order_Date TIMESTAMP(0) NOT NULL,
Planned_Delivery_Date TIMESTAMP(0) NOT NULL,
Actual_Delivery_Date TIMESTAMP(0) NOT NULL,
