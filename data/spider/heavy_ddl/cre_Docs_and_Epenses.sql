DROP DATABASE IF EXISTS cre_Docs_and_Epenses;
CREATE DATABASE cre_Docs_and_Epenses;
ALTER SESSION SET CURRENT_DATABASE = 'cre_Docs_and_Epenses';
...
Budget_Type_Description TEXT NOT NULL);
