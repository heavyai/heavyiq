DROP DATABASE IF EXISTS behavior_monitoring;
CREATE DATABASE behavior_monitoring;
ALTER SESSION SET CURRENT_DATABASE = 'behavior_monitoring';
...
detention_type_code TEXT NOT NULL,
teacher_id INTEGER,
