DROP DATABASE IF EXISTS customers_and_addresses;
CREATE DATABASE customers_and_addresses;
ALTER SESSION SET CURRENT_DATABASE = 'customers_and_addresses';
...
active_from_date TIMESTAMP(0) NOT NULL,
active_to_date TIMESTAMP(0),
