DROP DATABASE IF EXISTS tracking_software_problems;
CREATE DATABASE tracking_software_problems;
ALTER SESSION SET CURRENT_DATABASE = 'tracking_software_problems';
...
date_problem_reported TIMESTAMP(0) NOT NULL,
date_problem_closed TIMESTAMP(0),
