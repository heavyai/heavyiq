DROP DATABASE IF EXISTS customer_deliveries;
CREATE DATABASE customer_deliveries;
ALTER SESSION SET CURRENT_DATABASE = 'customer_deliveries';
...
customer_phone TEXT,
customer_email TEXT,
date_became_customer TIMESTAMP(0)
);
...
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (1, 'Torphy Ltd', '16893 Wilderman Terrace Port Lucasburgh, ND 55978-5550');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (2, 'Heidenreich Group', '6534 Cheyenne Trace Suite 242 Koryburgh, PA 21391-9164');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (3, 'Gerhold Inc', '70469 Unique Crest Katherynville, IA 92263-4974');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (4, 'Huel, Armstrong and Senger', '534 Lubowitz Terrace Lake Tomfort, LA 52697-4998');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (5, 'Nader, Leuschke and Huels', '4627 Johnnie Centers Lake Hipolitoton, RI 37305');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (6, 'Abshire Ltd', '36578 Kirsten Terrace Krajcikside, NH 29063');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (7, 'Adams, Macejkovic and Carroll', '941 Ritchie Plains Suite 833 North Jerry, LA 32804-7405');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (8, 'Schowalter Group', '52417 Wiza Brook Apt. 000 Zechariahstad, WY 15885-3711');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (9, 'Gorczany Group', '9608 Hoyt Extension East Linnieview, GA 87356-5339');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (10, 'Grady, King and Price', '4989 Pfeffer Passage Suite 915 West Jacebury, SD 68079-3347');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (11, 'Streich, Spencer and Brakus', '30335 Pacocha Burgs Apt. 400 North Onastad, OR 76419');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (12, 'Brekke, Powlowski and Fritsch', '53685 Abshire Falls Lake Destineyville, OK 91313');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (13, 'Hermiston, Feeney and Daugherty', '54645 Ziemann Skyway Suite 987 Lake Roderickstad, OH 77820');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (14, 'Renner-Kovacek', '809 Daija Radial Apt. 507 Kavonfort, MN 70034-2797');
INSERT INTO Delivery_Routes (route_id, route_name, other_route_details) VALUES (15, 'Hegmann-Waters', '719 Vito Parks Kassulkeville, NH 77748');
