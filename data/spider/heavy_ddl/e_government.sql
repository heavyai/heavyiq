...
ALTER SESSION SET CURRENT_DATABASE = 'e_government';
...
date_contact_from TIMESTAMP(0) NOT NULL,
date_contact_to TIMESTAMP(0));
...
date_completion_started TIMESTAMP(0) NOT NULL,
form_status_code TEXT NOT NULL,
date_fully_completed TIMESTAMP(0));
CREATE TABLE Party_Services (
booking_id INTEGER NOT NULL ,
customer_id INTEGER NOT NULL,
service_id INTEGER NOT NULL,
service_datetime TIMESTAMP(0) NOT NULL,
booking_made_date TIMESTAMP(0));
