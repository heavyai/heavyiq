DROP DATABASE IF EXISTS insurance_and_eClaims;
CREATE DATABASE insurance_and_eClaims;
ALTER SESSION SET CURRENT_DATABASE = 'insurance_and_eClaims';
...
Policy_ID INTEGER NOT NULL,
Date_of_Claim TIMESTAMP(0),
Date_of_Settlement TIMESTAMP(0),
Amount_Claimed DECIMAL(18,4),
Amount_Piad DECIMAL(18,4));
...
Claim_Status_Name TEXT NOT NULL,
Claim_Status_Description TEXT NOT NULL);
