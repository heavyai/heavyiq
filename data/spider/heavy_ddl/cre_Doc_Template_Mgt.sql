DROP DATABASE IF EXISTS cre_Doc_Template_Mgt;
CREATE DATABASE cre_Doc_Template_Mgt;
ALTER SESSION SET CURRENT_DATABASE = 'cre_Doc_Template_Mgt';
...
Template_Type_Code CHAR(15) NOT NULL,
Date_Effective_From TIMESTAMP(0),
Date_Effective_To TIMESTAMP(0),
