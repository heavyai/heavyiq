...
CREATE DATABASE tracking_grants_for_research;
ALTER SESSION SET CURRENT_DATABASE = 'tracking_grants_for_research';
...
response_received_date TIMESTAMP(0) NOT NULL,
other_details TEXT NOT NULL);

CREATE TABLE Grants (
grant_id INTEGER ,
organisation_id INTEGER NOT NULL,
grant_amount DECIMAL(18,4) NOT NULL DEFAULT 0,
grant_start_date TIMESTAMP(0) NOT NULL,
grant_end_date TIMESTAMP(0) NOT NULL,
other_details TEXT NOT NULL);

CREATE TABLE Organisation_Types (
organisation_type TEXT ,
organisation_type_description TEXT NOT NULL
);

CREATE TABLE Organisations (
organisation_id INTEGER ,
organisation_type TEXT NOT NULL,
organisation_details TEXT NOT NULL);
